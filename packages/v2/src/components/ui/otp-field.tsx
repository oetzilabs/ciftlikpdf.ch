...
export const OTPField = <T extends ValidComponent = "div">(props: DynamicProps<T, OTPFieldProps<T>>) => {
  const [local, rest] = splitProps(props, ["class"]);

  return <OTPFieldPrimitive class={cn("flex items-center gap-2 has-[:disabled]:opacity-50", local.class)} {...rest} />;
};
