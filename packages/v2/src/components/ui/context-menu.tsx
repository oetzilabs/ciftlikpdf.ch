...
type contextMenuSubContentProps<T extends ValidComponent = "div"> = ContextMenuSubContentProps<T> & {
  class?: string;
};
...
type contextMenuContentProps<T extends ValidComponent = "div"> = ContextMenuContentProps<T> & {
  class?: string;
};
...
type contextMenuItemProps<T extends ValidComponent = "div"> = ContextMenuItemProps<T> & {
  class?: string;
  inset?: boolean;
};
...
type contextMenuCheckboxItemProps<T extends ValidComponent = "div"> = ParentProps<
      ...
      <ContextMenuPrimitive.ItemIndicator class="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-2 w-2">
          <g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
            ...
            <path fill="currentColor" d="M7 3.34a10 10 0 1 1-4.995 8.984L2 12l.005-.324A10 10 0 0 1 7 3.34" />
          </g>
          <title>Radio</title>
        </svg>
      </ContextMenuPrimitive.ItemIndicator>
...
type contextMenuItemLabelProps<T extends ValidComponent = "div"> = ContextMenuItemLabelProps<T> & {
  class?: string;
  inset?: boolean;
};
...
type contextMenuGroupLabelProps<T extends ValidComponent = "span"> = ContextMenuGroupLabelProps<T> & {
  class?: string;
  inset?: boolean;
};
...
export const ContextMenuSeparator = <T extends ValidComponent = "hr">(
  ...
  return <ContextMenuPrimitive.Separator class={cn("-mx-1 my-1 h-px bg-border", local.class)} {...rest} />;
};
