...
export const DatePickerViewControl = (props: DatePickerViewControlProps) => {
  ...
  return (
    <DatePickerPrimitive.ViewControl class={cn("flex items-center justify-between", local.class)} {...rest}>
...
export const DatePickerTable = (props: DatePickerTableProps) => {
  ...
  return <DatePickerPrimitive.Table class={cn("w-full border-collapse space-y-1", local.class)} {...rest} />;
};
...
export const DatePickerViewTrigger = (props: DatePickerViewTriggerProps) => {
  ...
  return (
    <DatePickerPrimitive.ViewTrigger class={cn(buttonVariants({ variant: "ghost" }), "h-7", local.class)} {...rest} />
  );
};
