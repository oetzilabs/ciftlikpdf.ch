    ...
    <div class="p-4 text-black dark:text-white border border-neutral-300 dark:border-neutral-800 shadow-sm rounded-md bg-white dark:bg-black flex flex-col w-full gap-2">
      <div class="flex flex-row items-center justify-between">
        ...
        <div class="flex flex-row items-center justify-center gap-2">
          <a href={`/sponsor/${props.sponsor.id}/edit`}
          ...
          <button class="w-full h-full text-sm font-semibold text-red-500 bg-red-50 px-3 py-1 border border-red-300 rounded-md hover:bg-red-100 flex flex-row items-center gap-2 dark:bg-red-900 dark:text-red-100 dark:border-red-500"
            onClick={async () => {
