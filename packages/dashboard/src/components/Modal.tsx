    ...
    <Dialog.Root open={props.open} onOpenChange={props.onOpenChange ? props.onOpenChange : (open) => {}}>
      ...
      <Dialog.Portal>
        ...
        <div class="flex flex-col ">
          <Dialog.Content class="z-50 absolute top-0 left-0 h-screen md:h-auto md:top-[50%] md:left-[50%] md:-translate-x-[50%] md:-translate-y-[50%] flex flex-col gap-2 w-full md:w-[500px] max-w-full bg-white dark:bg-black p-4 border border-black/10 dark:border-white/10 rounded-sm shadow-xl transition-[height]">
